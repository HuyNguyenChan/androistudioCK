...
//         Hiển thị notification
        ...
        Glide.with(this)
            .asBitmap()
            .load(ApiConfig.getFullUrl(song?.image)) // Convert đường dẫn tương đối thành URL đầy đủ
    ...
    fun playFromUrl(url: String) {
        mediaPlayer?.apply {
            reset()
            // Convert đường dẫn tương đối thành URL đầy đủ để phát audio
            val fullUrl = ApiConfig.getFullUrl(url) ?: url
