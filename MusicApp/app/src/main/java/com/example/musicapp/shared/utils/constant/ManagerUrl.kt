...
object ManagerUrl {
    ...
    const val BASE_URL = "http://192.168.2.16:3000/api/"
    
    // Base URL cho static files (không có /api/)
    // Được sử dụng để serve audio, video, images từ thư mục public/
    // Lưu ý: Nếu thay đổi IP, cần cập nhật cả BASE_URL và STATIC_BASE_URL
    const val STATIC_BASE_URL = "http://192.168.2.16:3000/"
